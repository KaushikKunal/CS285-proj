...
def run_training_loop(args):
    ...
    print(agent.actor.mean_net)
    agent.actor.mean_net = my_utils.shrink_that_thang(agent.actor.mean_net, debug_print=True)
    print(agent.actor.mean_net)
    # print(type(agent.actor.logits_net))
    # agent.actor.logits_net = my_utils.shrink_that_thang(agent.actor.logits_net, debug_print=True)
    # print(type(agent.actor.logits_net))
    # exit()
    total_envsteps = 0
